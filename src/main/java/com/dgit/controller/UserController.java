...
import com.dgit.domain.PictureFileDTO;
...
public class UserController {
	...
	public void postRegisterMember(Student student, TransferMethod transferMethod, StudentGrade studentGrade,
	...
	public @ResponseBody Map<String, Object> postLoginForAndroid(String memberType, String id, String password)
			throws Exception {
		String memberName = "";
	...
	@ResponseBody 
	@RequestMapping(value="/imageChange", method=RequestMethod.POST)
	public Map<String, Object> postImageChangeForAndroid(PictureFileDTO pic) throws Exception{
		Map<String, Object> map = new HashMap<>();		
		String pictureName = null;
		String memberType = pic.getMemberType();
		String memberId = pic.getMemberId();
		logger.info("=============imageChange==================");
		...
		if(memberType.equalsIgnoreCase(LoginInterceptor.STUDENT)){
			try{
				...
				MultipartFile pictureFile = pic.getPictureFile();
				...
				if (pictureFile != null) {
					...
					pic.setFileName(originalFileName);
						pictureName = UploadFileUtils.uplaodFile(
										uploadPath, 
										pictureFile.getOriginalFilename(), 
										pictureFile.getBytes());
						Student student = new Student();
						student.setsId(memberId);
						student.setsPicture(pictureName);
