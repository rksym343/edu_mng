INSERT INTO subject (sb_name, sb_is_del) VALUES('국어', 0),('영어', 0),('수학', 0),('사회', 0),('과학', 0);


INSERT INTO student_grade (gd_no, gd_name) values
(1, '초1'), (2, '초2'), (3, '초3'), (4, '초4'), (5, '초5'), (6, '초6'), 
(7, '중1'), (8, '중2'), (9, '중3'), (10, '고1'), (11, '고2'), (12, '고3');

INSERT INTO teacher (t_id, t_password, t_name, t_phone, t_subject, t_picture)
		VALUES('aaa01', 'aaa01', '김선생', '010-7777-7777', 1, '사진');
		

INSERT INTO registration_status (rs_no, status) values
(1, '결제'),(2,'미결제'),(3,'결제취소'),(4,'미연장');

INSERT INTO transfer_method (tm_no, tm_method) values
(1, 'SMS'), (2, 'APP'), (3, 'HOME'),(4, 'SMS&APP'),(5, 'SMS&HOME'),(6, 'APP&HOME'),(7, 'SMS&APP&HOME');

INSERT INTO attendance_status (as_no, as_status) values 
(1, '결석'),(2, '등원'),(3, '지각'),(4, '조퇴'),(5, '하원');

INSERT INTO exam_item (ei_no, ei_title) values 
...
INSERT INTO course (c_no, t_id, gd_no, sb_no, c_name, is_canceled)
...
INSERT INTO attendance (s_id, the_time, as_no) values 
...
INSERT INTO course_register (reg_month, reg_s_id, reg_c_no, rs_no) values 
(201705, 'sss01', 1, 1),
(201706, 'sss01', 1, 1),
(201707, 'sss01', 1, 1),
(201707, 'sss01', 2, 1),
...
INSERT INTO timetable (c_no, tt_day, tt_starttime, tt_endtime, tt_version) values
(1, 0, 16, 17, 1),
(2, 1, 16, 17, 1),
(3, 1, 18, 20, 1),
(2, 3, 16, 17, 1),
...
INSERT INTO examination (sb_no, s_id, ei_no, e_result, e_memo, e_date) values
(1,'sss01', 1, 90, '', '2017-04-20'),
(1,'sss01', 2, 90, '', '2017-06-20');

INSERT INTO examination (sb_no, s_id, c_no, ei_no, e_result, e_memo, e_date) values
...
INSERT INTO message (t_id, c_no, s_id, sp_id, msg_content, is_checked, reg_date) values
